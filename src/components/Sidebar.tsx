        ...
        <div className="p-4 border-t border-earth-border/10 bg-earth-dark-accent/40">
          {currentUser ? (
            <div className="space-y-4">
              ...
              {/* Developer Testing Console inside Account box */}
              <div className="bg-earth-dark/50 border border-earth-border/5 rounded-lg p-2 flex items-center justify-between text-[11px] font-mono text-earth-border/70">
                <span>Role: <strong className="text-earth-accent uppercase">{currentUser.role}</strong></span>
                <button 
                  id="role-switch-btn"
                  onClick={onSwitchRole} 
                  className="px-1.5 py-0.5 rounded bg-white/10 hover:bg-earth-accent/20 text-white transition-all text-[10px]"
                >
                  Swap Role
                </button>
              </div>
